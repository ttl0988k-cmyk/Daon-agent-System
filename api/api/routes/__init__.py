...
def handle_get(handler, parsed) -> bool:
    ...
    if parsed.path == '/api/capability/diagnose':





        return handle_get_capability_diagnose(handler, parsed)
    ...
    if parsed.path == '/api/capability/tests':





        return handle_get_capability_tests(handler, parsed)
    ...
    if parsed.path == '/api/capability/mappings':





        return handle_get_capability_mappings(handler, parsed)
...
# ── Style Cards API (GET) ──
    ...
    # ── Creative Director API (GET) ──




    if parsed.path == '/api/creative-director/health':




        return handle_get_creative_director_health(handler, parsed)
    ...
    if parsed.path == '/api/creative-director/cards':




        return handle_get_creative_director_cards(handler, parsed)
...
# ── KakaoTalk Bridge API (GET) ──
    ...
    # ── Mobile Bridge API (GET) ──
    if parsed.path == '/m':
        return handle_get_mobile(handler, parsed)

    if parsed.path == '/static/mobile.js':
        return handle_get_mobile_js(handler, parsed)
...
def handle_post(handler, parsed) -> bool:
    ...
    # #34 fix: multipart/form-data routes (whisper, etc.) must be dispatched BEFORE





    # read_body() consumes rfile bytes. read_body() reads all Content-Length bytes





    # and parses as JSON, destroying binary multipart data for downstream handlers.
    ...
    if parsed.path == '/api/chat/cancel':
        ...
        return handle_post_chat_cancel(handler, body)
    ...
    # ── Capability Routing (POST) ──





    if parsed.path == '/api/capability/route':





        return handle_post_capability_route(handler, body)
...
# ── Style Cards API (POST) ──
    ...
    # ── Creative Director API (POST) ──



    if parsed.path == '/api/creative-director/brief':



        return handle_post_creative_director_brief(handler, body)
    ...
    if parsed.path == '/api/creative-director/cards/extract':



        return handle_post_creative_director_card_extract(handler, body)
