    ...
    try:
        ...
        try:
          ...
          workspace_system_msg = (
              ...
              "BEFORE calling any tool, write one short Korean sentence announcing what\n"
              "you are about to do (예: '브라우저로 example.com을 열어보겠습니다.'). Never\n"
              "call a tool silently — the user must always know what is happening.\n\n"
              "[WEBUI ENVIRONMENT]\n"
