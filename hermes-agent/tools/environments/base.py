...
class BaseEnvironment(ABC):
    ...
    def _wait_for_process(self, proc: ProcessHandle, timeout: int = 120, stream_callback: callable = None) -> dict:
        ...
        If *stream_callback* is provided, it is called with each decoded
        text chunk as it arrives, enabling real-time terminal output streaming.
        """
            ...
            if sys.platform == "win32":
                try:
                    while True:
                        ...
                        if stream_callback and decoded:
                            try:
    ...
    def execute(
        ...
        *,
        ...
        result = self._wait_for_process(proc, timeout=effective_timeout, stream_callback=stream_callback)
        self._update_cwd(result)
